...
class ExperimentLogger:
    ...
    def _columns(self) -> List[str]:
        cfg_fields = [
            ...
            "model.anchor.enabled",
            "model.anchor.target",
            "model.anchor.pre_encoder_layers",
            "model.anchor.lambda_h",
            "model.anchor.lambda_pre",
            "model.anchor.pre_encoder_head",
            "model.anchor.detach_target",
            "model.anchor.norm",
            "model.anchor.teacher.enabled",
            "model.set_diversity.lambda_div",
            "model.multivector_basis.enabled",
            "model.multivector_basis.r",
            "model.candidate_fiber",
            ...
            "resolved.anchor_enabled",
            "resolved.anchor_target",
            "resolved.anchor_pre_encoder_layers",
            "resolved.anchor_lambda_h",
            "resolved.anchor_lambda_pre",
            "resolved.anchor_pre_encoder_head",
            "resolved.anchor_detach_target",
            "resolved.anchor_norm",
            "resolved.anchor_teacher_enabled",
            "resolved.set_diversity_lambda_div",
            "resolved.multivector_basis_enabled",
            "resolved.multivector_basis_r",
            "resolved.candidate_fiber",
        ]
