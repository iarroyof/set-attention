...
TASK_METRICS = {
    "lm": [
        ...
        "val/span_ablation_fine_loss",
        "val/span_ablation_fine_ppl",
        "val/span_ablation_fine_delta_loss",
        "val/span_ablation_fine_delta_ppl",
        "val/span_ablation_coarse_loss",
        "val/span_ablation_coarse_ppl",
        "val/span_ablation_coarse_delta_loss",
    ...
    "lca_cmp": [
        ...
        "val/valid_tokens",
        "val/exact_sequence_accuracy",
        "val/bucket/near_below_count",
        "val/bucket/near_below_loss",
        "val/bucket/near_below_ppl",
        "val/bucket/near_below_accuracy",
        "val/bucket/near_above_count",
        "val/bucket/near_above_loss",
        "val/bucket/near_above_ppl",
        "val/bucket/near_above_accuracy",
    ],
...
SET_DIAGNOSTICS = [
    ...
    "ausa/candidate_count_min",
    "ausa/candidate_count_max",
    "ausa/router_candidate_count_mean",
    "ausa/router_candidate_count_min",
    "ausa/router_candidate_count_max",
    "ausa/router_candidate_count_struct_mean",
    "ausa/router_candidate_count_struct_min",
    "ausa/router_candidate_count_struct_max",
    "ausa/router_candidate_count_eff_mean",
    "ausa/router_candidate_count_eff_min",
    "ausa/router_candidate_count_eff_max",
    ...
    "ausa/pooling_head_entropy_mean",
    "ausa/pooling_head_entropy_std",
    "ausa/pooling_head_js_to_mean",
    "ausa/pooling_head_top1_agreement",
    "ausa/pooling_head_prob_var",
    "ausa/grad_norm_token_pre_pool",
    "ausa/grad_norm_set_post_pool",
    "ausa/grad_norm_set_post_blocks",
    "ausa/grad_ratio_pool_rho_p",
    "ausa/grad_ratio_set_stack_rho_a",
    "ausa/grad_ratio_total_rho_pa",
    "ausa/grad_probe_nonfinite_count",
    "ausa/diagnostics_nonfinite_count",
