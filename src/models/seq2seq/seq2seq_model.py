    ...
    def __init__(
        ...
        if encoder_family == "set_only":
            ...
            self.encoder = SetOnlyLM(
                ...
                pooling_multihead=bool(set_only_cfg.get("pooling_multihead", False)),
                ...
                router_multihead=bool(set_only_cfg.get("router_multihead", False)),
                router_temperature=float(set_only_cfg.get("router_temperature", 1.0)),
                router_min_temp=float(set_only_cfg.get("router", {}).get("min_temp", 0.5)),
                ...
                token_mlp=set_only_cfg.get("token_mlp"),
        ...
        if self.decoder_family == "set_only":
            ...
            if cross_attention == "set_only":
                ...
                cross_attn = SetOnlyCrossAttention(
                    ...
                    router_temperature=float(cross_cfg.get("router_temperature", 1.0)),
                    router_min_temp=float(cross_cfg.get("router", {}).get("min_temp", 0.5)),
            ...
            self.decoder = SetOnlyLM(
                ...
                pooling_multihead=bool(decoder_cfg.get("pooling_multihead", False)),
                ...
                router_multihead=bool(decoder_cfg.get("router_multihead", False)),
                router_temperature=float(decoder_cfg.get("router_temperature", 1.0)),
                router_min_temp=float(decoder_cfg.get("router", {}).get("min_temp", 0.5)),
                ...
                token_mlp=decoder_cfg.get("token_mlp"),
