...
- [Canonical multiresolution research program](../docs/set_dictionary_research_main_plan.md) —
  program gates, agent ownership, memory tiers, and durable handoff contract
- [Agent subplans](../docs/agent_plans/README.md) — independent end-to-end task
  plans and status vocabulary
- [Set Attention research direction](set-attention-research-direction.md) — current exact-dense
  multiresolution matrix, claim boundary, and inactive legacy families
