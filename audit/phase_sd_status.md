...
Last updated: 2026-06-16 20:05 CST by Codex after validating SD-3 on blue-demon.
...
Start SD-5: prepare the S1 ladder (`anchor_span`, anchor disabled, CE only, dense backend) using
the existing direct references. SD-2 and SD-3 gates are PASS; no ladder run has been launched yet.
